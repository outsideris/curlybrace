...
describe('questions', function() {
  ...
  describe('질문 조회', function() {
    ...
    it('질문을 가져올 때 질문 댓글의 날짜도 뷰에 필요한 형식으로 포매팅한다', function(done) {
      var questionFixture = {
        title: '테스트 제목',
        contents: '#본문입니다.\r\n\r\n* 질문\r\n* 질문..\r\n\r\n        var a = "test"',
        tags: 'scala,javascript'
      ...
      questions.insert(questionFixture, currentUser, function(err, insertedQuestion) {
        ...
        comments.insert({questionId: insertedQuestion[0]._id}, comment, currentUser, function(err) {
          ...
          questions.findOneById(insertedQuestion[0]._id, function(err, foundQuestion) {
            ...
            should.exist(foundQuestion.comments[0].regDate);
            should.exist(foundQuestion.comments[0].regDateFromNow);
            should.exist(foundQuestion.comments[0].regDateformatted);
            done();
          });
        });
      });
    });
    it('질문을 가져올 때 답변 댓글의 날짜도 뷰에 필요한 형식으로 포매팅한다', function(done) {
      var questionFixture = {
        title: '테스트 제목',
        contents: '#본문입니다.\r\n\r\n* 질문\r\n* 질문..\r\n\r\n        var a = "test"',
        tags: 'scala,javascript'
          ...
          questionsCollection.findOne({_id: insertedQuestion[0]._id}, function(err, foundQuestion) {
            ...
            comments.insert({
              ...
              questions.findOneById(insertedQuestion[0]._id, function(err, foundQuestion) {
                ...
                should.exist(foundQuestion.answers[0].comments[0].regDate);
                should.exist(foundQuestion.answers[0].comments[0].regDateFromNow);
                should.exist(foundQuestion.answers[0].comments[0].regDateformatted);
                done();
              });
            });
          });
